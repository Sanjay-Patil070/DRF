...
SECRET_KEY = "django-insecure-e^orr^a6o@p6(n+r78%q2fpnm2aeoi4&aavr774cgs$h_3_$_#"
...
AUTH_USER_MODEL = "practice_api.User"
from datetime import timedelta

SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=60),  # 60 mins
